...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/10/18 15:46:58 by jihokim2          #+#    #+#             */
/*   Updated: 2022/10/20 16:02:38 by jihokim2         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	char_count(char *str, char *charset, char **split, int word_count)
{
	int	arr[4];
...
void	copy(char *str, char *charset, char **split, int index)
{
	int	flag;
	int	i;
	int	j;
...
char	**ft_split(char *str, char *charset)
{
	...
	index = word_count(str, charset);
	split = (char **) malloc (sizeof(char *) * (index + 1));
	if (split == 0)
		return (0);
	split[index] = 0;
	char_count(str, charset, split, index);
	copy(str, charset, split, index);
	return (split);
}
